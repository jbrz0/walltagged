...
import {
  Card, CardText, GridList, GridTile,
  Slider, Toggle, MenuItem, CardHeader,
...
import dataJson from './dataTemplateThree.json';
  ...
  _renderTile(drawing, index) {
    return (
      <GridTile
        ...
        actionIcon={<IconButton onTouchTap={() => this._removeMe(index)}><RemoveIcon color="#FDFFFC"/></IconButton>}>
        <img src={drawing}/>
      </GridTile>
    );
  }
            ...
            <div className='col-xs-5 col-sm-5 col-md-3 col-lg-3 menu-sidebar'>
              <Card style={{margin: '0'}}>
                ...
                <CardText expandable={true} style={{background: '#EDF2F4', borderRadius: '0'}}>
                  ...
                  <IconButton onTouchTap={this._redo}
                  ...
                  {/* <IconButton onTouchTap={this._download}>
                    <i className={materialIcons}>file_download</i>
                  </IconButton>Download Data <br /> */}
              ...
              <Card style={{margin: '0'}}>
                ...
                <CardText expandable={true} style={{background: '#EDF2F4', borderRadius: '0'}}>
                  ...
                  <div>
                    <IconButton
                      ref='zoom' onTouchTap={() => this._sketch.zoom(1.25)}>
                        <i className={materialIcons}>zoom_in</i>
                    </IconButton>
                    <IconButton
                      ref='zoom1' onTouchTap={() => this._sketch.zoom(0.8)}>
              ...
              <Card initiallyExpanded={true} style={{margin: '0'}}>
                ...
                <CardText expandable={true} style={{background: '#EDF2F4', borderRadius: '0'}}>
                  ...
                  <Toggle label="Fill"
                    ...
                    onToggle={() => this.setState({fillWithColor: !this.state.fillWithColor})}/>
                  <CompactPicker
